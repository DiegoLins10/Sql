...
-- Caso banco exisir, apaga
If Exists (Select name From master..sysdatabases Where name ='Pessoa_Veiculo')
	Drop Database Pessoa_Veiculo
go

Create Database Pessoa_Veiculo
